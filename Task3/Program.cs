...
namespace Task3
{
    class Program
    {
        ...
        {
            return Convert.ToInt16(move, 10) >= 1 && Convert.ToInt16(move, 10) <= playerChoiceArray.Length;
        }
        ...
        public static string compChoice(string[] computerChoice)
        {
            int compChoise = new Random().Next(1, computerChoice.Length + 1);
        ...
        {
            string compMove = optionsArray[Int16.Parse(compOption) - 1];
            string playerMove = optionsArray[Int16.Parse(playerOption) - 1];
        ...
        {
            int computerMove = Convert.ToInt16(computerChoice, 10);
            int playerMove = Convert.ToInt16(playerChoice, 10);
